...
function end( num1,num2,num3){
  ...
  document.getElementById('item'+num1).style.background= 'rgb(65, 3, 151)';
 document.getElementById('item'+num2).style.background= 'rgb(65, 3, 151)';
  document.getElementById('item'+num3).style.background= 'rgb(65, 3, 151)';
  document.querySelector('.title').style.background= 'rgb(65, 3, 151)';
